...
#include "../../../include/UtilityHeaders/SimpleGraphModel.hpp"
...
static constexpr auto qt_meta_stringdata_ZN16SimpleGraphModelE = QtMocHelpers::stringData(
    "SimpleGraphModel"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16SimpleGraphModelE[] = {
...
Q_CONSTINIT const QMetaObject SimpleGraphModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16SimpleGraphModelE.offsetsAndSizes,
    qt_meta_data_ZN16SimpleGraphModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16SimpleGraphModelE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SimpleGraphModel, std::true_type>
    >,
    nullptr
} };
...
void *SimpleGraphModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16SimpleGraphModelE.stringdata0))
