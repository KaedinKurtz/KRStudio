...
#include "../../../../qtnodes-src/include/QtNodes/internal/ConnectionGraphicsObject.hpp"
...
static constexpr auto qt_meta_stringdata_ZN7QtNodes24ConnectionGraphicsObjectE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN7QtNodes24ConnectionGraphicsObjectE[] = {
...
Q_CONSTINIT const QMetaObject QtNodes::ConnectionGraphicsObject::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7QtNodes24ConnectionGraphicsObjectE.offsetsAndSizes,
    qt_meta_data_ZN7QtNodes24ConnectionGraphicsObjectE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7QtNodes24ConnectionGraphicsObjectE_t,
        // Q_OBJECT / Q_GADGET
...
void *QtNodes::ConnectionGraphicsObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7QtNodes24ConnectionGraphicsObjectE.stringdata0))
