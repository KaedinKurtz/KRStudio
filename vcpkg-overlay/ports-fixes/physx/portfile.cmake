...
vcpkg_cmake_configure(
    ...
    # OVERLAY FIX (KRStudio): the upstream port passes GENERATOR "${generator}" with
    # ${generator} never set. WINDOWS_USE_MSBUILD makes Windows ignore it, but on
    # Linux the empty generator hits vcpkg_cmake_configure's "Unable to determine
    # appropriate generator for: Linux-x64-external" fatal error (seen in ci-linux
    # run 40). Dropping the argument lets the helper pick its default (Ninja).
    WINDOWS_USE_MSBUILD
    OPTIONS
